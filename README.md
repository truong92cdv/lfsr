...
After runing synthesis, we got netlist file **netlist/lfsr_synth.v**, gate schematic **netlist/lfsr_synth.dot**, and the log file **log/synth.log**. In the log file, we can see
...
OpenLane would automatically create the **config.json** file as below:
...
First, go to the **results** dir in your final RUN_* directory
...
```sh
klayout final/gds/lfsr.gds
```

![KLayout](./images/6_klayout.png)
...
- Design **LFSR with Analog flow** and compare the result.
